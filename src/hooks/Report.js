...
const Report = (props) => {
    ...
    return (
        ...
        <div>
        {lastesito === 0 && 
         <span style={{position:'relative', top:'8px', right:'40px'}}> <img src={neu}></img></span>
           
         }
         {lastesito === props.id && 
        <span style={{position:'relative', top:'8px', right:'40px'}}>  <img src={up}></img></span>
           
         }
          {lastesito != props.id && lastesito !=0 &&
           <span style={{position:'relative', top:'8px', right:'40px'}}>  <img src={down}></img></span>
          }
         </div>
