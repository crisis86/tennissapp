                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    {myrole === 'admin' &&
                                        <div className="form-group">
                                            ...
                                            <input type="number" style={{ background: '#d3e472', opacity: 1, color: "black" }} value={posizione} onChange={e => posizionechange(parseInt(e.target.value))} className="form-control"></input>
                                ...
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        ...
                                        <input disabled={myrole==="player"} value={name} onChange={e => namechange(e.target.value)} className="form-control"></input>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div className="form-group">
